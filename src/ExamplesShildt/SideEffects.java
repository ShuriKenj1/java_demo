...
// Демонстрация роли побочных эффектов логических операторов
public class SideEffects {
    public static void main(String[] args) {
        ...
        System.out.println("Инкремент внутри оператора if выполняется: " +
                i); // отображается 1
        ...
        if (false && (++i < 100))
            System.out.println("Эта строка не будет отображаться");
        System.out.println("Оператор if выполняется, но инкремент нет: " +
                i); // по-прежнему отображается 1, инкремент не выполнился
    }
}
